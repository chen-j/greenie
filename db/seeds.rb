...
s1 = saints.matches.create!(teamAName:"Peterhouse Boys U15", teamBName:"St George's College U15", venue:"Peterhouse Boys", city: "Marondera", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2016,12,24,15,30), competition:"League Match")
s2 = saints.matches.create!(teamAName:"Peterhouse Boys U15", teamBName:"St George's College U15", venue:"Peterhouse Boys", city: "Marondera", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2016,12,24,15,30), competition:"League Match")
s3 = saints.matches.create!(teamAName:"Girls College 1st", teamBName:"Chisipite Senior 1st", venue:"Chisipite Senior School", city: "Harare", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2016,12,28,15,30), competition:"Bruce Kennedy Cup 2016")

f1 = falcon.matches.create!(teamAName:"Hellenic Academy U17", teamBName:"Falcon College U17", venue:"Falcon College", city: "Esigodhini", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2016,12,14,15,30), competition:"Bruce Kennedy Cup 2016")
f2 = falcon.matches.create!(teamAName:"St John's College U14", teamBName:"Peterhouse Boys U14", venue:"St John's College", city: "Harare", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2016,12,17,15,30), competition:"Exhibition")
f2 = falcon.matches.create!(teamAName:"Chisipite Senior U17", teamBName:"Hellenic Academy U17", venue:"Hellenic Academy", city: "Harare", firstRef:"Peter Moore", secondRef:"Thomas James", matchdate:DateTime.new(2017,1,13,19,30), competition:"Crusaders Shield 2017")
...
j2.match_events.create!(event_name:"Ejection",players:"Arnold Dube", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Jonathan Mukamba", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Peter Marshall", team:"St John's College 1st")
j2.match_events.create!(event_name:"Goal",players:"John Mukamba", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Peter Marshall", team:"St John's College 1st")
j2.match_events.create!(event_name:"Goal",players:"John Mukamba", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Peter Mole", team:"St John's College 1st")
j2.match_events.create!(event_name:"Goal",players:"John Mukamba", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Peter Marshall", team:"St John's College 1st")
j2.match_events.create!(event_name:"Goal",players:"John Mukamba", team:"St George's College 1st")
j2.match_events.create!(event_name:"Goal",players:"Peter Marshall", team:"St John's College 1st")
